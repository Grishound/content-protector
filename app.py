...
app.config['SQLALCHEMY_DATABASE_URI'] = 'postgres://abtlbysebxpqrb:d0b1ae227e4ff8249dcac8919b5f8b8efa56b58233f0424a6a1301262d7057d1@ec2-52-206-182-219.compute-1.amazonaws.com:5432/dalnnavugi3sqs'
db = SQLAlchemy(app)
